...
import { clearCache, deleteToken, fetchInfo, fetchProjects, userInfo, } from "./api";
...
export const Dashboard: Component<{}, {}, { "on:routeshown": () => void }> = function(cx) {
	...
	return (
		<div>
			<RandomBackground />
			{allData.map(([a, b]) => !!a && !!b).andThen(() => <DashboardComponent user={userInfo.data!} projects={userInfo.projects!} />, <Loading />)}
